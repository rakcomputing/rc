...
const PrivacyPage = () => (
  <main style={{ maxWidth: 800, margin: "0 auto", padding: 24, fontFamily: 'sans-serif' }}>
    ...
    <p>These terms and conditions apply to the Votmean Mobile app (hereby referred to as "Application") for mobile devices that was created by Raksmey Chann (hereby referred to as "Service Provider") as a Free service.</p>
    ...
    <p><strong>These terms and conditions are effective as of 2025-07-15</strong></p>

    <h2>Contact Us</h2>
    <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at <a href="mailto:raksmey.itmoh@gmail.com">raksmey.itmoh@gmail.com</a>.</p>
  </main>
);
